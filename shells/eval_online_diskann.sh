...
# Online AGI Eval (Massive-Serve API) - DiskANN
# Usage:
#   ./eval_online_diskann.sh
#   K=10 L=2000 W=4 THREADS=128 BATCH=100 API_URL=http://128.208.4.44:30888/search ./eval_online_diskann.sh
...
OUT_DIR="output/llama-8B-agi-k=${K}-diskann-online-L${L}-W${W}-T${THREADS}"
...
echo "[Eval] Online AGI Eval (DiskANN)"
